...
import { THEME_COLOR, base_url, blog_base_url, HEADER_COLOR } from '../../../Config/Config'
                                ...
                                <>
                                    <ArrayList
                                        ...
                                        renderItem={({ item, index }) => {
                                            return (
                                                <RecentPhotos item={item} topPhotos={topPhotos} index={index} photoView={photoView} photoLikes={photoLikes} photoFullUrl={photoFullUrl} parents={parents} comment={comment} loading={loading} useRef={useRef} navigation={navigation}
