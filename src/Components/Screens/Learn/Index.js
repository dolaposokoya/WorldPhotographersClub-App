                ...
                <ArrayList
                    ...
                    renderItem={({ item }) => (
                        <TouchableOpacity style={Styles.gradientView} onPress={() => goToCourseDetails(item)}>
                            ...
                            <LinearGradient colors={[LINEAR_WHITE, LINEAR_BLUE]} start={{ x: 0.8, y: 0.2 }}
                                end={{ x: 0.1, y: 0.9 }} style={Styles.gradient}>
                ...
                <ArrayList
                    ...
                    renderItem={({ item }) => (
                        <View style={Styles.gradientView1}>
                            ...
                            <LinearGradient colors={[LINEAR_WHITE, THEME_COLOR_BACKGROUND]} start={{ x: 0.8, y: 0.2 }} end={{ x: 0.1, y: 0.9 }} style={Styles.gradient1}>
