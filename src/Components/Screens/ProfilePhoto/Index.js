...
import { fonts, HEADER_COLOR, INTEREST_COLOR, OTHER_GRAY, PLUS_COLOR, THEME_COLOR, THEME_COLOR_BACKGROUND, WHITE } from '../../../Config/Config'
...
export default function Index(props) {
    ...
    return (
        <>
            ...
            />
            <SharedHeader navigation={navigation} name="Profile Photo" open={true} />
            <>
                <View>
