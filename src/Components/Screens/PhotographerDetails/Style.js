...
import { THEME_COLOR, LIGHT_GRAY, BLACK, OFF_WHITE, BACKGROUND, NAVY_BLUE, WHITE, fontSize, fonts, TEXT_COLOR, OTHER_GRAY, THEME_COLOR_BACKGROUND, LIGHT_GRAY1 } from '../../../Config/Config'
