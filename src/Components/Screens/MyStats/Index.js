...
import { View, Text, Dimensions, Image, TouchableOpacity, ScrollView, StatusBar, Pressable } from 'react-native'
import { moderateScale } from 'react-native-size-matters'
import { fonts, INTEREST_COLOR, PLUS_COLOR, THEME_COLOR } from '../../../Config/Config'
        ...
        <>
            ...
            >
                ...
                <View style={[Styles.userStatView, { opacity: 1, backgroundColor: 'transparent' }]}>
                    <Text style={[Styles.userStatViewText, { fontFamily: fonts.bold, color: THEME_COLOR }]}>INSIGHTS</Text>
                    <Text style={[Styles.userStatViewText, { fontFamily: fonts.bold, color: THEME_COLOR }]}>COUNT</Text>
                </View>
