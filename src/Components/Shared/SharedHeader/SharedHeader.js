...
export default function SharedHeader(props) {
    const { back, name, children, navigation, profile, username, topPhoto, editProfile, saveDetails, editUser, option, backgroundColor } = props
    return (
        <>
            ...
            >
                ...
                : <View style={{
                    ...
                    {topPhoto ? <PhotoSheet profileContainer={Styles.profileContainer} backBtn={Styles.backBtn} navigation={navigation} username={username} /> : <CustomSheet profileContainer={Styles.profileContainer} backBtn={Styles.backBtn} navigation={navigation} editUser={editUser} />}
                </View>}
        </>
    )
}
