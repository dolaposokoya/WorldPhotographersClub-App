...
export default function PhotoSheet(props) {
    const { profileContainer, backBtn, navigation, username, editUser } = props
                ...
                >
                    <View style={{
                        ...
                        <View style={Style.sheet}>
                            ...
                            <TouchableOpacity style={Style.sheetOptions} onPress={() => navigateToPage('OtherStats')}>
                                <Text style={Style.sheetOptionstText}>{username} Stats</Text>
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity style={[Style.sheetOptions, { borderBottomWidth: 0 }]} onPress={() => navigateToPage('AccountSettings')}>
                    ...
                    <View style={Style.sheetBottom}>
                        <TouchableOpacity style={Style.sheetOptions1} onPress={() => actionSheetRef.current?.setModalVisible(false)}>
                            <Text style={[Style.sheetOptionstText, { fontFamily: fonts.bold }]}>Cancel</Text>
                        </TouchableOpacity>
                    </View>
                </ActionSheet>
            </>
